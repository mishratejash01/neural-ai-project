...
const About = () => {
    ...
    return (
        <Layout>
            ...
            <section className="py-24 text-center gradient-hero">
                <div className="container mx-auto px-4">
                    <h1 className="md:text-5xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400">
            ...
            {/* Incubation Section - Styled Correctly */}
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                            <div className="space-y-4">
                                ...
                                <p className="text-muted-foreground">
                                    Solutions built on cutting-edge research, not just existing tools.
                                </p>
                            </div>
                            <div className="space-y-4">
                                <div className="text-3xl font-bold text-gradient">Business-Focused</div>
                                <p className="text-muted-foreground">
                                    AI is only valuable if it drives real business outcomes.
                                </p>
                            </div>
                            <div className="space-y-4">
                                <div className="text-3xl font-bold text-gradient">Human-Centric</div>
                                <p className="text-muted-foreground">
                                    We design AI that enhances human capabilities, not replace them.
                                </p>
                            </div>
                        </div>
                        <Link to="/services">
