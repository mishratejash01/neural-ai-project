...
import { motion, useScroll, useTransform } from "framer-motion"; // Restored framer-motion imports
...
const About = () => {
    ...
    return (
        <Layout>
            {/* PERFORMANCE FIX: 
                Replaced 'zoom: 0.9' (CPU heavy) with 'transform: scale(0.9)' (GPU accelerated).
                width 111.12% compensates for the 0.9 scale (100/0.9).
                -ml-[5.56%] centers the expanded width ((111.12 - 100) / 2).
            */}
            <div className="w-[111.12%] -ml-[5.56%] transform scale-90 origin-top will-change-transform">
                
                {/* 1. HERO - Height adjusted to 111vh to appear as 100vh after 0.9 scaling */}
