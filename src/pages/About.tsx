    ...
    return (
        <Layout>
            <div className="w-full bg-white font-['Inter']">
                ...
                <div className="relative z-10 bg-white w-[90%] max-w-[1600px] mx-auto -mt-20 rounded-t-[2.5rem] shadow-2xl overflow-hidden pb-20">
                    ...
                    <section className="py-24 px-4 md:px-0 bg-white">
                        <div className="text-center pb-12">
                                {/* Removed small "Leadership & Engineering" text */}
