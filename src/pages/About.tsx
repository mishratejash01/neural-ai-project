...
import { BackgroundCells } from "@/components/ui/background-cells"; // <-- ADD THIS LINE
        ...
        <Layout>
            ...
            <BackgroundCells className="bg-slate-950">
              <div className="text-center">
                <h1 className="md:text-5xl lg:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400 pointer-events-none">
                    About <span className="text-gradient">Neural AI</span>
                </h1>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto mt-6 pointer-events-none">
