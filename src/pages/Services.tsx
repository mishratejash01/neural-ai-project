    ...
    <Layout>
      <LampContainer>
        ...
        <motion.p
          ...
          className="mt-4 text-center text-lg text-muted-foreground max-w-3xl"
        >
          At Neural AI, we deliver cutting-edge artificial intelligence solutions that transform how businesses operate. From intelligent automation to predictive insights, we have the expertise to drive your digital transformation with measurable results.
        </motion.p>
      </LampContainer>
      <ServicesPageContent />
    </Layout>
