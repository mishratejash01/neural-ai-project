    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), hsl(var(--primary)), transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), transparent, transparent, hsl(var(--primary)))`,
          }}
