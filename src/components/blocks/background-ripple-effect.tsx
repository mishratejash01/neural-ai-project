...
export const BackgroundCells = ({ children, className }: BackgroundCellsProps) => {
  return (
    <div className={cn("relative flex justify-center items-center overflow-hidden", className)}>
      <BackgroundCellCore />
      {children && (
  ...
  return (
    ...
    >
      <div className="absolute h-full inset-y-0 overflow-hidden">
        ...
        >
          <Pattern cellClassName="border-primary/20 relative z-[100]" />
        </div>
      ...
      {matrix.map((row, rowIdx) => (
        ...
        >
          {row.map((column, colIdx) => {
            ...
            }, [clickedCell, controls, colIdx, rowIdx]);
