      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="w-full md:w-1/2 p-8 relative z-10 flex flex-col justify-center items-center md:items-start text-center md:text-left">
          ...
          <BlurText
            ...
            className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 justify-center md:justify-start"
            animateBy="words"
            delay={100}
          />
          ...
          <BlurText
            ...
            className="mt-4 text-neutral-300 max-w-lg justify-center md:justify-start"
            animateBy="words"
            delay={50}
          />
